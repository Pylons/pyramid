...
class TestPRequestCommand(unittest.TestCase):
    ...
    def test_command_not_enough_args(self):
        ...
        self.assertEqual(
            self._out_calls,
            [('You must provide at least two arguments', sys.stderr)],
        )
    ...
    def test_command_two_args(self):
        ...
        self.assertEqual(self._out_calls, [('abc', sys.stdout)])
    ...
    def test_command_display_headers(self):
        ...
        self.assertEqual(
            ...
            [
                ('200 OK', sys.stdout),
                ('Content-Type: text/html; charset=UTF-8', sys.stdout),
                ('abc', sys.stdout),
            ],
        )
    ...
    def test_command_response_has_no_charset(self):
        ...
        self.assertEqual(self._out_calls, [(b'abc', sys.stdout)])
