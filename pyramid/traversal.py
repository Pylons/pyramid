...
def traversal_path_info(path):
    ...
    .. note::
      ...
      tuples returned by :func:`pyramid.traversal.resource_path_tuple`.
       As a result, tuples generated by ``traversal_path`` are not resolveable
      by the :func:`pyramid.traversal.find_resource` API.  ``traversal_path``
      is a function mostly used by the internals of :app:`Pyramid` and by
      people writing their own traversal machinery, as opposed to users writing
...
class ResourceURL(object):
    ...
    def __init__(self, resource, request):
        ...
        self.virtual_path_tuple = virtual_path_tuple
        self.physical_path_tuple = physical_path_tuple
