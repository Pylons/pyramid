...
:app:`Pyramid` 是一个小型，快速，接地气的 web 框架.  它是作为 `Pylons Project <https://pylonsproject.org>`的一部分而被开发.
它是基于 `BSD-like 许可 <http://repoze.org/license.html>`_.

这是一个最简单的 :app:`Pyramid` 程序例子:
