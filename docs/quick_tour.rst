...
.. code-block:: bash
    ...
    $VENV/bin/cookiecutter gh:Pylons/pyramid-cookiecutter-starter --checkout 2.1-branch
...
.. code-block:: bash
    ...
    cd ~
    env/bin/cookiecutter gh:Pylons/pyramid-cookiecutter-starter --checkout 2.1-branch
