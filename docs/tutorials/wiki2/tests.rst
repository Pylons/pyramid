...
Open ``pyramidtut/tests/test_views.py``, and edit it such that it appears as follows:

.. literalinclude:: src/tests/pyramidtut/tests/test_views.py
    :linenos:
    :language: python

Open ``pyramidtut/tests/test_functional.py``, and edit it such that it appears as follows:

.. literalinclude:: src/tests/pyramidtut/tests/test_functional.py
    :linenos:
    :language: python
...
.. note::
    ...
    We're utilizing the excellent `WebTest <http://docs.pylonsproject.org/projects/webtest/en/latest/>`_ package to do functional testing of the application. This is defined in the ``tests_require`` section of our ``setup.py``. Any other dependencies needed only for testing purposes can be added there and will be installed automatically when running ``setup.py test``.
