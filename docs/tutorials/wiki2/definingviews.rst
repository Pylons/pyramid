...
`http://github.com/Pylons/pyramid/tree/1.0-branch/docs/tutorials/wiki2/src/views/
<http://github.com/Pylons/pyramid/tree/1.0-branch/docs/tutorials/wiki2/src/views/>`_.
...
<http://github.com/Pylons/pyramid/blob/1.0-branch/docs/tutorials/wiki2/src/views/tutorial/static/pylons.css>`_.
