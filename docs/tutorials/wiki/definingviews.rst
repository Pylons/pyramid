...
`http://github.com/Pylons/pyramid/tree/1.1-branch/docs/tutorials/wiki/src/views/
<http://github.com/Pylons/pyramid/tree/1.1-branch/docs/tutorials/wiki/src/views/>`_.
...
<http://github.com/Pylons/pyramid/blob/1.1-branch/docs/tutorials/wiki/src/views/tutorial/static/pylons.css>`_.
