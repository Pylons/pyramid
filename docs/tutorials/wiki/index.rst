...
tutorial can be browsed on GitHub at `GitHub <https://github.com/Pylons/pyramid/blob/master/docs/tutorials/wiki/src/>`_ for a specific branch or version under ``docs/tutorials/wiki/src``,
