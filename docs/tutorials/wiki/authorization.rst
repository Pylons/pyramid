...
`http://github.com/Pylons/pyramid/tree/1.1-branch/docs/tutorials/wiki/src/authorization/
<http://github.com/Pylons/pyramid/tree/1.1-branch/docs/tutorials/wiki/src/authorization/>`_.
